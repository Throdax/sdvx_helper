...
/**
 * Thin wrapper around {@link ResourceBundle} for internationalised message lookup.
 *
 * <p>Replaces the Python {@code poor_man_resource_bundle.py} custom implementation.
 * Message bundles are stored under
 * {@code src/main/resources/i18n/messages_en.properties} (and {@code _ja})
 * and follow the standard Java {@link ResourceBundle} naming convention.</p>
 *
 * <p>Usage:</p>
 * <pre>{@code
...
public class MessageService {
    ...
    /**
     * Constructs a {@code MessageService} for the given locale.
     * Falls back to {@link Locale#ENGLISH} if the bundle for the requested
     * locale cannot be found.
     *
     * @param locale desired locale (e.g. {@code Locale.JAPANESE})
     */
     ...
     * @throws MissingResourceException if the key is not found in the bundle
     */
     ...
     *
     * @param key  message key
     * @param args substitution arguments (used with {@code {0}}, {@code {1}}, … placeholders)
