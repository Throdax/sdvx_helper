 ...
 *
 * <p>All fields mirror those of {@link MusicInfo}. Only {@code title} is
 * mandatory; every other field has a sensible default so that call sites only
 * need to set what they actually know.</p>
 *
 * <p>Usage:</p>
 * <pre>{@code
 * MusicInfo info = new MusicInfoBuilder("冥")
 *         .artist("Camellia")
 *         .bpm("200")
 *         .difficulty("mxm")
 *         .lv("20")
 ...
 * }</pre>
 *
 * <p>The {@code date} setter is overloaded: pass a {@link LocalDateTime} directly
 * or a formatted string ({@code "yyyy-MM-dd HH:mm"} or bare {@code "yyyy-MM-dd"})
 * and it will be parsed via {@link MusicInfo#unmarshalDate(String)}.</p>
 *
 * @author Throdax
 * @since 2.0.0
 */
public class MusicInfoBuilder {
     ...
     *
     * @param title the song title (must not be {@code null})
     */
     ...
     *
     * @param lv the chart level string
     * @return this builder
     */
     ...
     *
     * @param bestScore the personal-best score
     * @return this builder
     */
     ...
     *
     * @param bestLamp the personal-best clear lamp
     * @return this builder
     */
     ...
     *
     * @param date the personal-best date
     * @return this builder
     */
     ...
     * ({@code "yyyy-MM-dd HH:mm"} or bare {@code "yyyy-MM-dd"}).
     * Unparseable values are silently ignored (date remains {@code null}).
     *
     ...
     * {@code "S"}).
     *
     * @param sTier the grade-S tier string
     * @return this builder
     */
     ...
     *
     * @param pTier the perfect-UC tier string
     * @return this builder
     */
