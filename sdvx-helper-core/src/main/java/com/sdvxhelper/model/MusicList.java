 ...
 *
 * <p>
 * Serialised to / deserialised from {@code musiclist.xml}. Replaces the Python
 * {@code musiclist.pkl} pickle file.
 * </p>
 *
 * <p>
 * The original Python structure is a nested dict:
 * </p>
 * 
 * <pre>{@code
 * {
 ...
 *
 * <p>
 * Each nested dict is represented here as a list of typed JAXB elements to work
 * around JAXB's lack of native support for
...
public class MusicList {
     ...
     *
     * @param jacket
     *            the list of jacket {@link DifficultyHashGroup} entries to set
     */
     ...
     *
     * @param info
     *            the list of info-bar {@link DifficultyHashGroup} entries to set
     */
     ...
     *
     * @param jacketSha
     *            the list of jacket SHA {@link DifficultyHashGroup} entries to set
     */
     ...
     *
     * @param titles
     *            the list of {@link SongInfoEntry} song metadata entries to set
     */
     ...
     *
     * @param gradeSTable
     *            the list of {@link GradeSEntry} grade-S tier table entries to set
     */
