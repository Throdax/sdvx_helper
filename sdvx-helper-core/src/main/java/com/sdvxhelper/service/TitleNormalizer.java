 ...
 *
 * <p>
 * Wraps the lookup logic previously spread across
 * {@code sdvx_utils.restore_title()} and {@code find_song_rating()} in the
 * Python code. All data is loaded at startup from
 * {@link SpecialTitlesRepository}.
 * </p>
 *
 * @author Throdax
 * @since 2.0.0
...
public class TitleNormalizer {
     ...
     *
     * @param repository
     *            source of special-title mappings
     */
     ...
     *
     * @param fsafeTitle
     *            filesystem-safe title (special characters removed/replaced)
     * @return canonical game title, or the input string unchanged if no mapping
     *         exists
     */
    ...
    /**
     * Returns {@code true} if the given title should be excluded from result
     * output.
     *
     * @param title
     *            title to test
