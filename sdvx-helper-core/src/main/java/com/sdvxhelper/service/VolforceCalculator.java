 ...
 *
 * <p>
 * Maps to the Python {@code get_vf_single()} methods in {@code OnePlayData} and
 * {@code MusicInfo}, and the total-VF calculation in
 * {@code SDVXLogger.update_total_vf()} in {@code sdvxh_classes.py}.
 * </p>
 *
 * @author Throdax
 * @since 2.0.0
...
public final class VolforceCalculator {
    ...
    /**
     * The maximum possible score for a single play, used to normalise the VF
     * formula.
     */
     ...
     *
     * @param lamp
     *            clear lamp string (e.g. {@code "puc"}, {@code "uc"},
     *            {@code "clear"})
     ...
     *
     * <p>
     * Returns {@code 0} if {@code levelInt} is negative (e.g. the level is
     * {@code "??"})
     * </p>
     *
     * @param score
