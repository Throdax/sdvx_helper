 ...
 *
 * <p>This class is the data model; it is loaded at runtime by
 ...
 * {@code special_titles.json} does not require recompilation.</p>
 *
 * <p>JSON-B annotations map to the {@code special_titles.json} key names.</p>
 *
 * @author Throdax
 * @since 2.0.0
 */
public class SpecialTitles {
     ...
     *
     * <p>Example: {@code "archivezip" → "archive::zip"}</p>
     */
    @JsonbProperty("specialTitles")
    private Map<String, String> specialTitles = Collections.emptyMap();

    /**
     * Manual level-rating overrides for charts that are not in the main
     * song-list database.
     *
     * <p>Example: {@code "SomeTitle" → ["APPEND:20", "EXH:18"]}</p>
     */
     ...
     *
     * @param fsafeTitle filesystem-safe title string
    ...
    /**
     * Returns the override rating list for the given title, or an empty list
     * if no override is defined.
     *
     * @param title title to check
     * @return list of rating override strings (e.g. {@code ["APPEND:20", "EXH:18"]})
     */
     ...
     */
    public Map<String, String> getSpecialTitles() { return specialTitles; }

    /**
     * Sets the special-titles map.
     *
     * @param specialTitles filesystem-safe title → canonical title map
     */
     ...
     */
    public Map<String, List<String>> getDirectOverrides() { return directOverrides; }

    /**
     * Sets the direct-overrides map.
     *
     * @param directOverrides title → rating-override-list map
     */
     ...
     */
    public List<String> getIgnoredNames() { return ignoredNames; }

    /**
     * Sets the ignored-names list.
     *
     * @param ignoredNames list of ignored title strings
     */
     ...
     */
    public List<String> getDirectRemoves() { return directRemoves; }

    /**
     * Sets the direct-removes list.
     *
     * @param directRemoves list of titles to remove
     */
