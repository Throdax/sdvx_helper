...
class VersionUtilTest {
    ...
    void compareVersionStrings(String v1, String v2, int expectedSign) {
        ...
        if (expectedSign < 0) Assertions.assertTrue(result < 0, "Expected " + v1 + " < " + v2);
        else if (expectedSign > 0) Assertions.assertTrue(result > 0, "Expected " + v1 + " > " + v2);
        else Assertions.assertEquals(0, result, "Expected " + v1 + " == " + v2);
    }
